...
class _$QuoteModelImpl extends _QuoteModel {
  ...
  @override
  String toString() {
    return 'QuoteModel(id: $id, content: $content, author: $author, image: $image, translation: $translation)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, author, image, translation);
...
abstract class _QuoteModel extends QuoteModel {
  const factory _QuoteModel(
      ...
      required final String translation}) = _$QuoteModelImpl;
